...
if __name__ == '__main__':
  ...
  world = CognitiveGame(initial_state, final_states, n_solution, n_token, n_attempt, n_user_action, timeout=15,  trans_filename="../trajectories/trans_matrix_prob.npy")

  #trajectories = T.load_trajectories(file="../trajectories/trajectories_generation0.npy", episode=50, population=100)
  transition_tables = world.load_transition_prob(file="../trajectories/trans_matrix_prob.npy")


  for state in final_states:
    point_to_index = world.state_point_to_index(state)
    transition_tables[point_to_index][point_to_index][0] = 1
